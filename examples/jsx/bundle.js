...
var items = [{ label: 'a', url: 'http://a.com' }, { label: 'b', url: 'http://b.com' }, { label: 'c', url: 'http://c.com' }];

var menu = h(Menu, { items: items, active: 'b' });

document.body.appendChild(createElement(menu));

},{"..":3,"virtual-dom":13,"virtual-dom/create-element":10}],2:[function(require,module,exports){

},{}],3:[function(require,module,exports){
module.exports = h => (tag, options, children) => typeof tag !== 'function' ? h(tag, options, children) : tag(options);
...
},{"browser-split":4}],25:[function(require,module,exports){
